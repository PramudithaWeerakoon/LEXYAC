...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_COMMAND_ERROR = 4,              /* COMMAND_ERROR  */
  YYSYMBOL_EOL = 5,                        /* EOL  */
  YYSYMBOL_SQRT = 6,                       /* SQRT  */
  YYSYMBOL_EXPONENT = 7,                   /* EXPONENT  */
...
{
       0,    25,    25,    26,    35,    36,    42,    45,    46,    47,
      48,    49,    57,    58,    59,    62,    63,    64,    74,    75,
      78,    79,    80
};
#endif
...
static const char *const yytname[] =
{
  ...
  "COMMAND_ERROR", "EOL", "SQRT", "EXPONENT", "MODULO", "'+'", "'-'",
  "'*'", "'/'", "'('", "')'", "'h'", "'q'", "$accept", "input", "line",
  "expr", "term", "factor", "command", YY_NULLPTR
};
...
{
     -12,     0,   -12,     9,   -12,   -12,    33,   -12,   -12,    42,
      27,    43,   -12,    37,   -12,     4,     4,     4,     4,     4,
       4,   -12,    11,   -12,    37,    30,   -12,    30,    30,    30,
      30,    30,   -12,    19,     4,     4,   -12,   -12,   -12
};
...
{
       2,     0,     1,     0,     7,    22,     0,    20,    21,     0,
       6,     0,     5,     0,     3,     0,     0,     0,     0,     0,
       0,     4,     0,    18,     0,    13,    15,    14,     8,     9,
      10,    11,    12,     0,     0,     0,    19,    16,    17
};
...
{
       2,     3,    22,     4,     5,     0,     6,    23,    27,    28,
      29,    30,    31,    33,    12,     7,     8,    24,    15,    16,
      17,    18,    19,    20,     0,    32,    15,    16,    17,    18,
      19,    20,     0,    36,    15,    16,    17,    18,    19,    20,
       4,    34,    35,     6,    37,    38,    13,    14,    21
};

static const yytype_int8 yycheck[] =
{
       0,     1,    13,     3,     4,    -1,     6,     3,    16,    17,
      18,    19,    20,    24,     5,    15,    16,    13,     7,     8,
       9,    10,    11,    12,    -1,    14,     7,     8,     9,    10,
      11,    12,    -1,    14,     7,     8,     9,    10,    11,    12,
       3,    11,    12,     6,    34,    35,    13,     5,     5
};
...
{
       0,    18,     0,     1,     3,     4,     6,    15,    16,    19,
      20,    23,     5,    13,     5,     7,     8,     9,    10,    11,
      12,     5,    20,     3,    13,    21,    22,    21,    21,    21,
      21,    21,    14,    20,    11,    12,    14,    22,    22
};
...
#line 1168 "calc.tab.c"
  ...
  case 12: /* expr: SQRT '(' expr ')'  */
#line 57 "calc.y"
                        { yyval = sqrt(yyvsp[-1]); }
#line 1174 "calc.tab.c"
    break;

  case 13: /* expr: expr EXPONENT term  */
#line 58 "calc.y"
                         { yyval = pow(yyvsp[-2], yyvsp[0]); }
#line 1180 "calc.tab.c"
    break;

  case 14: /* expr: expr MODULO term  */
#line 59 "calc.y"
